...
class MainWidget(GridLayout):
    def __init__(self, **kwargs):
        ...
        left_grid_2_1.add_widget(Label(text = "Object", size_hint=(.2, .2)))
        object_name = 'default.jpg'
        object = Image(source=object_name)
        left_grid_2_1.add_widget(object)
    ...
    def update_componen(self, **kwargs):
        left_grid_2 = GridLayout(
            size_hint_y = None,
            height = 300,
            cols = 10,
        ...
        # print(self.obj_position)
        for key in self.obj_position:
            left_grid_2_1 = GridLayout(
                    size_hint_x = None,
                    width = 200,
                    padding = 5,
            ...
            left_grid_2_1.add_widget(Label(text = "Object" + str(self.obj_position[key]), size_hint=(.2, .2)))
            object_name = 'default.jpg'
            object = Image(source=object_name)
            left_grid_2_1.add_widget(object)
            input_object_z = TextInput(text='12', multiline=False, size_hint=(.2, .2))
            left_grid_2_1.add_widget(input_object_z)
            btn_grab_obj = Button(text="Go", font_size=16, size_hint=(.30, .30))
            btn_grab_obj.bind(on_press=self.move_object)
            left_grid_2_1.add_widget(btn_grab_obj)
            left_grid_2.add_widget(left_grid_2_1)
        self.left_grid.add_widget(left_grid_2)
    ...
    def final_calculation(self, *args):
        ...
        self.move_object(round(coor_x, 4), round(coor_y, 4), round(coor_z, 4))
    ...
    def move_object(self, x, y, z, speed=30, wait=True):
        ...
        z_1 = z + 50
        z_2 = z
        status = self.terminal_robot.text + " | X: " + str(x) + " Y: " + str(y) + " Z: " + str(z) + "\n"
        self.terminal_robot.text = status

        # X, Y, Z, SPEED
        self.swift.set_position(x, y, z_1, speed=30, wait=True)
        time.sleep(1)
        self.swift.set_position(x, y, z_2, speed=20, wait=True)
        time.sleep(1)
        ...
        time.sleep(1)
        self.swift.set_position(x, y, z_1, speed=20, wait=True)
        time.sleep(1)
        self.swift.reset()
