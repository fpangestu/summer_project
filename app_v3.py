...
class MainWidget(GridLayout):
    def __init__(self, **kwargs):
        ...
        # path_to_file = './summer_project/last_camera_mtx.txt'
        # path = pathlib.Path(path_to_file)

        # if path.is_file():
        #     self.camera_mtx = np.loadtxt("./summer_project/last_camera_mtx.txt")
        # else:
        #     self.camera_mtx = []

        # path_to_file = './summer_project/last_camera_dist.txt'
        # path = pathlib.Path(path_to_file)

        # if path.is_file():
        #     self.camera_dist = np.loadtxt("./summer_project/last_camera_dist.txt")
        # else:
        #     self.camera_dist = []
