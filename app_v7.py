...
class MainWidget(GridLayout):
    def __init__(self, **kwargs):
        ...
        print(f'camera_tvec: {self.camera_tvec}')
        print(f'coordinate_robot: {self.coordinate_robot}')
        print(f'T: {self.T}')
        print(f'final: {self.coordinate_marker_for_robot}')
    ...
    def calculate_final_matrix(self, *args):   
        ...
        # tvec = np.append(self.camera_tvec[int(self.input_marker_id.text)], 1)
        # tvec = np.array(tvec).reshape(1,4)
        # coor = tvec @ self.T 
